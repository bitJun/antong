...
import { isVNode, toValue, isRef } from 'vue';
...
const _ChgcC6D8PqKBzZgqw2KRZ1Tt7qSa7zB0yaCzv1qrCkE = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/Vision/worokspace/antong";
...
const _TTDSei6gEcHns4y8WDcFFtA3a2g00EWnCNzG_TyUU0 = (nitroApp) => {
...
const plugins = [
  _ChgcC6D8PqKBzZgqw2KRZ1Tt7qSa7zB0yaCzv1qrCkE,
_TTDSei6gEcHns4y8WDcFFtA3a2g00EWnCNzG_TyUU0
];
...
const _lazy_j6kvtt = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_j6kvtt, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_j6kvtt, lazy: true, middleware: false, method: undefined }
];
...
export { getResponseStatus as a, appId as b, buildAssetsURL as c, defineRenderHandler as d, appTeleportTag as e, appTeleportAttrs as f, getResponseStatusText as g, getQuery as h, createError$1 as i, createSSRContext as j, appHead as k, getRouteRules as l, getRenderer as m, handler as n, publicAssetsURL as p, replaceIslandTeleports as r, setSSRError as s, useNitroApp as u };
